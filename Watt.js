...
function init3DObjects(sceneGraph) {
	...
	*/
	...
	P.position.set(coordP(theta,a,b,c)[0]-a,coordP(theta,a,b,c)[1],coordP(theta,a,b,c)[2]);
	Q.position.set(coordQ(theta,a,b,c)[0]-a,coordQ(theta,a,b,c)[1],coordQ(theta,a,b,c)[2]);
	M.position.set(coordM(theta,a,b,c)[0]-a,coordM(theta,a,b,c)[1],coordM(theta,a,b,c)[2]);
...
function initEmptyScene(sceneThreeJs) {
    ...
    sceneThreeJs.camera = sceneInit.createCamera(0,0,28);
